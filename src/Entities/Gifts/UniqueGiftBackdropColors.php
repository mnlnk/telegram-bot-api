...
/**
 * Описывает цвета фона уникального подарка.
 *
 * @link https://core.telegram.org/bots/api#uniquegiftbackdropcolors
 *
 * @method int getCenterColor() Цвет в центре фона в формате RGB.
 * @method int getEdgeColor()   Цвет по краям фона в формате RGB.
 * @method int getSymbolColor() Цвет, который будет применен к символу в формате RGB.
 * @method int getTextColor()   Цвет текста на фоне в формате RGB.
 */
#[Required([
    'center_color',
    'edge_color',
