### Доступные методы:
[Официальная документация](https://core.telegram.org/bots/api#available-methods) [ [9.6](https://core.telegram.org/bots/api#april-3-2026) ]
...
+ [deleteAllMessageReactions()](https://core.telegram.org/bots/api#deleteallmessagereactions) - Удаляет до 10000 недавних реакций в групповом или супергрупповом чате, добавленных определенным пользователем или чатом.
...
+ [getChatGifts()](https://core.telegram.org/bots/api#getchatgifts) - Получает подарки, принадлежащие чату.
