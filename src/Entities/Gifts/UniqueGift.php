 ...
 * @method    UniqueGiftModel getModel()    Объект модели подарка
 * @method   UniqueGiftSymbol getSymbol()   Объект символа подарка.
 * @method UniqueGiftBackdrop getBackdrop() Объект задника подарка.
 */
#[Required([
    'base_name',
    'name',
