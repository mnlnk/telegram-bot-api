 ...
 * @method string getElementHash() Хэш элемента в кодировке Base64.
 ...
 * @method $this setElementHash(string $elementHash) Хэш элемента в кодировке Base64.
...
class PassportElementErrorUnspecified extends PassportElementError
{
    ...
    {
        $data['source'] = PassportElementErrorSource::UNSPECIFIED;
